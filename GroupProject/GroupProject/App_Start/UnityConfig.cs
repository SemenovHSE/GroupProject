...
namespace GroupProject
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //container.RegisterType<IHttpModule, AuthenticationHttpModule>
            container.RegisterType<IAuthentication, ProjectAuthentication>(new PerRequestLifetimeManager());
            container.RegisterType<IUserIdentity, UserIdentity>(new PerRequestLifetimeManager());
